...
Mirrors home-infra's tools/config-drift/test_shipped_clean_gate.py -- same fixture shape,
same two properties pinned, adapted to this repo's simpler path-list API (no manifest
component dict, since this repo does not register with home-infra's fleet.json -- see the
