...
_USAGE_URL = "http://10.0.0.5:8123/api/states/sensor.georgia_power_usage_kwh"
_BILL_URL = "http://10.0.0.5:8123/api/states/sensor.georgia_power_bill_to_date"
_LAST_POLL_URL = "http://10.0.0.5:8123/api/states/sensor.georgia_power_last_poll"
...
def test_entity_url_strips_trailing_slash_from_base_url():
    ...
    assert (
        _entity_url("http://10.0.0.5:8123/", "sensor.foo")
        == "http://10.0.0.5:8123/api/states/sensor.foo"
    )
    assert (
        _entity_url("http://10.0.0.5:8123", "sensor.foo")
        == "http://10.0.0.5:8123/api/states/sensor.foo"
...
def test_push_to_ha_timeout_raises_publish_failed_without_leaking_exception_text():
    ...
    raw_exception_text = "connect timeout to 10.0.0.5:8123 with token abc123"
